...
# Run commands :
# source ~/.bashrc
# sh Run_Input_Data_Finance_Report.sh 20221031 5713
...
echo "------------------------------------------------------------------------------------------------------------------------------------------------------------- "
echo "------------------------------------Running DQ on saccr_report_OSFI-BFG-NEW_${EXEC_DATE}_${Run_ID}.csv (MARP-405) ------------------------------------------- "
echo "------------------------------------------------------------------------------------------------------------------------------------------------------------- "
...
FILE=${OUTPUT_DIR}/DQ/saccr_report_OSFI-BFG-NEW_${EXEC_DATE}_${Run_ID}.output.csv
if [ -f "$FILE" ]; then
...
mv ${INPUT_DIR}/saccr_report_OSFI-BFG-NEW_${EXEC_DATE}_${Run_ID}.csv ${INPUT_DIR}/saccr_report_OSFI-BFG-NEW_${EXEC_DATE}_${Run_ID}_orig.csv

# Copy New DQ output to prev
cp ${OUTPUT_DIR}/DQ/saccr_report_OSFI-BFG-NEW_${EXEC_DATE}_${Run_ID}.output.csv ${PREV_DIR}/saccr_report_OSFI-BFG-NEW.csv

mv ${OUTPUT_DIR}/DQ/saccr_report_OSFI-BFG-NEW_${EXEC_DATE}_${Run_ID}.output.csv ${INPUT_DIR}/saccr_report_OSFI-BFG-NEW_${EXEC_DATE}_${Run_ID}.csv 
...
# Rename Output File
mv ${OUTPUT_DIR}/Intermediate/overrides/saccr_report_OSFI-BFG-NEW_${EXEC_DATE}_${Run_ID}_output.csv ${OUTPUT_DIR}/Intermediate/overrides/saccr_report_OSFI-BFG-NEW_${EXEC_DATE}_${Run_ID}_transformed.csv
...
# Move Output File
mv ${OUTPUT_DIR}/Intermediate/filters/saccr_report_OSFI-BFG-NEW_${EXEC_DATE}_${Run_ID}_L1.csv ${OUTPUT_DIR}/saccr_report_OSFI-BFG-NEW_${EXEC_DATE}_${Run_ID}_L1.csv